...
{
    public string winterURL = "https://raw.githubusercontent.com/AlviRC/Thesis/refs/heads/main/Excel%20Files/SubjectLists.csv"; // GitHub CSV file URL
    ...
    IEnumerator LoadCSV()
    {
        ...
        void ParseCSV(string csvData)
        {
            ...
            while ((line = reader.ReadLine()) != null)
            {
                ...
                Debug.LogError(lineIndex + " The rows are: " + fields.Length);
                rows.Add(fields);
            }
        ...
        //         // Debug.LogError(line);
        //         lineIndex++;
        //         if (lineIndex <= 18) continue; // Ignore first 6 lines
        //         if (string.IsNullOrWhiteSpace(line)) break; // Stop at empty lines
        ...
        void PopulateScrollView(List<string[]> data)
        {
            ...
            foreach (var fields in data)
            {
                ...
                index++;
                // Debug.LogError(subjectText.text);
