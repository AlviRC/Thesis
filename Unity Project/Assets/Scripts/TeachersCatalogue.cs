...
{
    public string winterURL = "https://raw.githubusercontent.com/AlviRC/Thesis/refs/heads/main/Excel%20Files/TeachersInfo.csv"; // GitHub CSV file URL
    ...
    void Start()
    {
        StartCoroutine(LoadCSV(winterURL)); // Use StartCoroutine to load CSV
    }
    ...
    IEnumerator LoadCSV(string url)
    {
        ...
        /*The function below handles the parsing and orginizing of the read data from the repository to the corresponding panel*/
        // void ParseCSV(string csvData)
        // {
        //     StringReader reader = new StringReader(csvData);
        //     List<string[]> rows = new List<string[]>();
