...
{
    // public GameObject mapPanel;   // Assign the map panel in the inspector
    // public RectTransform marker;  // Assign the marker in the inspector
    // public Transform player;      // Assign the player object in the inspector
    // public Transform mapOrigin;   // Reference to the map's origin point in the world
    // public float mapScale = 5.0f; // Scale for converting world position to map
    // public float verticalOffset = 30f; // Tune this in the Inspector

    // void Update()
    // {
    //     // // Toggle map visibility on pressing 'E'
    ...
    // {
    //     // Get the player's position relative to the map origin
    //     Vector3 relativePos = player.position - mapOrigin.position;

    //     // Convert world coordinates to map coordinates
    //     Vector2 mapPos = new Vector2(relativePos.x, relativePos.z) * mapScale;
    //     mapPos.y -= verticalOffset; // move it down on the map
    //     marker.anchoredPosition = mapPos;



    //     // Update marker position on the UI map
    //     marker.anchoredPosition = mapPos;
    // }
